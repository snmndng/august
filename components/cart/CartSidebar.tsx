...
export function CartSidebar(): JSX.Element | null {
  ...
  return (
    <>
      ...
      />
      {/* Cart Sidebar */}
      <div className="fixed right-0 top-0 h-full w-full sm:w-96 bg-background text-foreground shadow-soft z-50 transform transition-transform duration-300 ease-in-out dark:bg-luxior-black dark:text-luxior-white">
        {/* Header */}
